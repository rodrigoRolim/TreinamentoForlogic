    ...
    contacts.forEach((contact)=>{
        ...
        let rows = `
            ...
            <tr id="info-${i}">
                ...
                <td>
                    <div class="foto-${contact._id}"></div>
                </td>
                     
                <td style="text-align:left">
                    
                    <p><span><strong>Nome:</strong> </span><span>${contact.name}</span></p>
                    <p><span><strong>Email:</strong> </span><span>${contact.email}</span></p>
                    <p><span><strong>Sexo:</strong> </span><span>${contact.sexo}</span></p>
                    <p><span><strong>Rua:</strong> </span><span>${contact.rua}</span></p>
                    <p><span><strong>Nº:</strong> </span><span>${contact.numero}</span></p>
                    <p><span><strong>Complemento:</strong> </span><span>${contact.complemento}</span></p>
                    <p><span><strong>Bairro:</strong> </span><span>${contact.bairro}</span></p>
                    <p><span><strong>${(contact.observacao != '')?'Observação':''}</strong> </span<span>${contact.observacao}</span></p>
